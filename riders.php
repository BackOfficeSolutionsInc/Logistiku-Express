...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="style/riders.css">
</head>
...
<body>
    ...
    <div class="section white"
        style="background-image: url('images/bg-riders.svg'); no-repeat; background-size: cover;">
        <div class="row container">
            <div class="row">
                ...
                <div class="col s6">
                    ...
                    <a class="waves-effect waves-dask btn-large">SIGN UP NOW</a>
                </div>
            </div>
        </div>
